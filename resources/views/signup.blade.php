			...
			<div class="col-md-6 col-lg-6 col-xl-7 d-none d-md-flex bg-primary-transparent">
				<div class="row wd-100p mx-auto text-center">
					<div class="col-md-12 col-lg-12 col-xl-12 my-auto mx-auto wd-100p">
						<img src="{{URL::asset('img/landing.jpg')}}" class="my-auto ht-xl-80p wd-md-100p wd-xl-80p mx-auto" alt="logo">
					</div>
				</div>
			</div>
			<!-- The content half -->
									...
									<div class="main-signup-header">
										...
										<form method="POST" action="/storeUser">
											...
											<div class="form-group">
												<label>Firstname &amp; Lastname</label> <input class="form-control" placeholder="Enter your firstname and lastname" 
												name="name" type="text">
											</div>
											<div class="form-group">
											...
											<div class="row row-xs">
												...
												<div class="col-sm-6 mg-t-10 mg-sm-t-0">
													<button class="btn  btn-block btn-google""><i class="fab fa-google"></i> <a style="color:#fff" href="auth/google">Signup with Google</a></button>
												</div>
											</div>
										</form>
